	...
	abstract class DecompiledMemberNodeBase : ItemNodeBase {
		public DecompiledMemberNodeBase(string name, ItemNodeBase parent, APIDiffInfo apiDiffInfo, FilterSettings filterSettings)
			...
			if (parentMember != null) {
				OldDecompileResult = parentMember.OldDecompileResult;
				NewDecompileResult = parentMember.NewDecompileResult;
			}
		}
		...
		public virtual string OldSource { get { return GetFullSource(OldDecompileResult); } }

		public virtual string NewSource { get { return GetFullSource(NewDecompileResult); } }
